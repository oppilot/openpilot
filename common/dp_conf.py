...
confs = [
  ...
  {'name': 'dp_lc_auto_min_mph', 'default': 2, 'type': 'UInt8', 'min': 0, 'max': 255, 'depends': [{'name': 'dp_lateral_mode', 'vals': [2]}], 'conf_type': ['param', 'struct']},
  {'name': 'dp_lc_auto_delay', 'default': 1., 'type': 'Float32', 'min': 0., 'max': 10., 'depends': [{'name': 'dp_lateral_mode', 'vals': [2]}], 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_toyota_auto_lock', 'default': True, 'type': 'Bool', 'conf_type': ['param', 'struct']},
