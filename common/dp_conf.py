...
confs = [
  ...
  {'name': 'dp_assisted_lc_min_mph', 'default': 1.0, 'type': 'Float32', 'min': 0, 'max': 255., 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_auto_lc_min_mph', 'default': 2.0, 'type': 'Float32', 'min': 0, 'max': 255., 'depends': [{'name': 'dp_auto_lc', 'vals': [True]}], 'conf_type': ['param', 'struct']},
