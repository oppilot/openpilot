...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'awareness_factor': Param(10., VT.number, 'Multiplier for the awareness times'),
                        ...
                        'dynamic_follow': Param('far', str, "Can be: ('close', 'normal', 'far'): Left to right increases in following distance.\n"
                        ...
                        'rsa_max_speed': Param(26.9, VT.number, 'Speed limit to ignore RSA in m/s'),
