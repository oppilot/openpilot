...
class DynamicFollow:
  ...
  def _get_TR(self):
    ...
    if df_profile == PROFILE_LONG:
      y_dist = [1.4078, 1.4232, 1.4418, 1.4636, 1.495, 1.5329, 1.5919, 1.6303, 1.7338, 1.8331, 1.8479, 1.8595, 1.8635]
      #y_dist = [1.3978, 1.4132, 1.4318, 1.4536, 1.485, 1.5229, 1.5819, 1.6203, 1.7238, 1.8231, 1.8379, 1.8495, 1.8535]  # TRs
      profile_mod_pos = [0.87, 0.65, 0.2, 0.1]
      #profile_mod_pos = [0.92, 0.7, 0.25, 0.15]
      profile_mod_neg = [1.15, 1.35, 2.05, 2.35]
